 ...
 * 超详细的时间工具类
 * @author laife
 * @version Id: DateUtil.java, v 0.1 2020/8/6 9:32 laife Exp $$
 */
public class DateUtil {
    ...
    public static long getDay(Date date) {
        ...
        try {
            //获取当前时间(YYYY-MM-DD)
            String current = GetDate("yyyy-MM-dd");
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            Date currentDate = sdf.parse(current);
            day = (currentDate.getTime() - date.getTime()) / (24 * 60 * 60 * 1000);
