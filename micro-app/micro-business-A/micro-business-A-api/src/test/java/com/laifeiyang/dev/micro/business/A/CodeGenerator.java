...
import com.laifeiyang.dev.micro.business.A.config.MybatisMySqlQuery;
import lombok.Data;
...
public class CodeGenerator {
     ...
     */
    public void init() {
        this.commonParentPackage = this.parentPackages + ".common";
        // 父类包路径
        ...
        this.commonOrderQueryParam = this.commonParentPackage + ".param.BaseParam";
    ...
    public void generator() {
        ...
        // 设置自定义查询
        dsc.setDbQuery(new MybatisMySqlQuery());
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                // 查询参数包路径
                String queryParamPackage = parentPackage + StringPool.DOT + "param";
                ...
                // 响应结果包路径
                String queryVoPackage = parentPackage + StringPool.DOT + ".vo";
        ...
        if (generatorQueryParam) {
            focList.add(new FileOutConfig("/templates/queryParam.java.vm") {
                @Override
                public String outputFile(TableInfo tableInfo) {
                    return projectPath + "/src/main/java/" + projectPackagePath + "/" + "/param/" + tableInfo.getEntityName() + "QueryParam" + StringPool.DOT_JAVA;
                }
            });
        }
